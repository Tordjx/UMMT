...
def make_vocab(pathinput,threshold):
    c= {}
    ...
    vocab = set()
    for word in c.keys() : 
        if threshold ==None or c[word] >= threshold :
            vocab.add(word)
    return vocab
pathinput = 'C:/Users/valen/Documents/ENSAE/STATAPP/multi30k-dataset/data/task1/tok/train.lc.norm.tok.fr'
codes = codecs.open('C:/Users/valen/Documents/ENSAE/STATAPP/codes_files_subword',encoding = 'utf-8')
input = codecs.open(pathinput,encoding = 'utf-8')
output  = codecs.open('C:/Users/valen/Documents/ENSAE/STATAPP/BPE.fr','w',encoding = 'utf-8')
threshold = None
vocabulary = make_vocab(pathinput,threshold)
merges = -1
separator = '@@'
glossaries = None
